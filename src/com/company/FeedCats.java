...
public class FeedCats {
    ...
    public static void main(String[] args) {
        ...
        Cat[] cat = new Cat[3];
        cat[0] = new Cat("Беляш", 150, 6);
        cat[1] = new Cat("Пухляш", 100, 4);
        cat[2] = new Cat("Злыдень", 40, 3);
        ...
        System.out.println(" Сейчас в миске " + plate.getFood() + " грамм кошачьего корма. Посмотрим насколько его хватит, в данный момент коты очень голодны и направляются поесть.\n");
